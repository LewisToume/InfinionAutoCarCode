...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
#define CHANNELS_NUM    1                       /* Number of used channels                                          */
...
IfxVadc_ChannelId g_vadcChannelIDs[] = {IfxVadc_ChannelId_0}; /* AN39: channel 0 of group 4                         */
...
void initVADCModule(void)
{
    ...
    adcConf.supplyVoltage = IfxVadc_LowSupplyVoltageSelect_3V;
