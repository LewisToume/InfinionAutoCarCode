...
void SCCB_Init(void)
{
    IfxPort_setPinMode(MT9V034_SCL_PIN, IfxPort_Mode_outputPushPullGeneral);
    IfxPort_setPinPadDriver(MT9V034_SCL_PIN, IfxPort_PadDriver_cmosAutomotiveSpeed1);

    IfxPort_setPinMode(MT9V034_SDA_PIN, IfxPort_Mode_outputPushPullGeneral);
    IfxPort_setPinPadDriver(MT9V034_SDA_PIN, IfxPort_PadDriver_cmosAutomotiveSpeed1);
