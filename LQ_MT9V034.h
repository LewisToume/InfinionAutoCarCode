...
#define MT9V034_SCL_PIN   &MODULE_P11,2   /*!< SCCB SCL 管脚 */
#define MT9V034_SDA_PIN   &MODULE_P11,3   /*!< SCCB SDA 管脚 */


#define MT9V034_SCL_Out   IfxPort_setPinMode(MT9V034_SCL_PIN, IfxPort_Mode_outputPushPullGeneral)      //配置输出作为SCL_Out
#define MT9V034_SDA_Out   IfxPort_setPinMode(MT9V034_SDA_PIN, IfxPort_Mode_outputPushPullGeneral)      //配置作为输出作为SDA_Out
#define MT9V034_SDA_In    IfxPort_setPinMode(MT9V034_SDA_PIN, IfxPort_Mode_inputPullUp)                //配置作为输入作为SDA_In
#define MT9V034_SCL_High  IfxPort_setPinState(MT9V034_SCL_PIN, IfxPort_State_high)                     //配置输出高电平
#define MT9V034_SCL_Low   IfxPort_setPinState(MT9V034_SCL_PIN, IfxPort_State_low)                      //配置输出低电平
#define MT9V034_SDA_High  IfxPort_setPinState(MT9V034_SDA_PIN, IfxPort_State_high)                     //配置输出高电平
#define MT9V034_SDA_Low   IfxPort_setPinState(MT9V034_SDA_PIN, IfxPort_State_low)                      //配置输出低电平
#define MT9V034_SDA_Data  IfxPort_getPinState(MT9V034_SDA_PIN)                                         //读取引脚上的引脚状态
